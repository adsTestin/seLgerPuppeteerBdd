...
const testUrl = 'http://localhost:8080/checkVoucherMsg.html';
...
describe('checkVaucherContainsText', () => {

  it('finds substrings of text', async () => {   
    console.log('coupon.invalid.code.provided')
    await checkContainsText.call(browserScope, '.alert-danger span', null, 'coupon.invalid.code.provided');
  });
